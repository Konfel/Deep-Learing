...
def run_training(training_loader, net, criteon, optimizer, weight_decay):
    if use_gpu:
    ...
    for batch, (data, target) in enumerate(training_loader):
        ...
        logits = net(data)
        classification_loss = criteon(logits, target)
        ...
        loss = classification_loss + weight_decay * regularization_loss
...
def work():
    ...
    for epoch in range(epoch_number):
        training_loss = run_training(training_loader, net, criteon, optimizer, weight_decay)
